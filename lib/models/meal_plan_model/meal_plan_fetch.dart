...
//
//     final mealPlanFetchModel = mealPlanFetchModelFromJson(jsonString);

import 'dart:convert';

MealPlanFetchModel mealPlanFetchModelFromJson(String str) => MealPlanFetchModel.fromJson(json.decode(str));

String mealPlanFetchModelToJson(MealPlanFetchModel data) => json.encode(data.toJson());

class MealPlanFetchModel {
  MealPlanFetchModel({
    this.id,
  ...
  factory MealPlanFetchModel.fromJson(Map<String, dynamic> json) => MealPlanFetchModel(
    id: json["id"],
    ...
    mealIngredientsWouldMake: json["meal_ingredients_would_make"].toDouble(),
    mealsPerDay: json["meals_per_day"].toDouble(),
    ...
    totalCaloriesInAMealPlan: json["total_calories_in_a_meal_plan"].toDouble(),
    totalImperialWeightOfAMealPlan: json["total_imperial_weight_of_a_meal_plan"].toDouble(),
    totalWeightOfAMealPlan: json["total_weight_of_a_meal_plan"].toDouble(),
...
class DailyAllowanceActualPercentage {
  ...
  factory DailyAllowanceActualPercentage.fromJson(Map<String, dynamic> json) => DailyAllowanceActualPercentage(
    ...
    // organMeat: List<dynamic>.from(json["Organ Meat"].map((x) => x)),
...
class AddFood {
  ...
  factory AddFood.fromJson(Map<String, dynamic> json) => AddFood(
    // yellow: List<Yellow>.from(json["Yellow"].map((x) => Yellow.fromJson(x))),
    // red: List<Map<String, List<String>>>.from(json["Red"].map((x) => Map.from(x).map((k, v) => MapEntry<String, List<String>>(k, List<String>.from(v.map((x) => x)))))),
  );

  Map<String, dynamic> toJson() => {
    "Yellow": List<dynamic>.from(yellow.map((x) => x.toJson())),
    "Red": List<dynamic>.from(red.map((x) => Map.from(x).map((k, v) => MapEntry<String, dynamic>(k, List<dynamic>.from(v.map((x) => x)))))),
  };
}
...
class Yellow {
  ...
  factory Yellow.fromJson(Map<String, dynamic> json) => Yellow(
    // calcium: json["Calcium"] == null ? null : List<String>.from(json["Calcium"].map((x) => x)),
    // phosphorus: json["Phosphorus"] == null ? null : List<String>.from(json["Phosphorus"].map((x) => x)),
  );
...
class Red {
  ...
  factory Red.fromJson(Map<String, dynamic> json) => Red(
    // magnesium: json["Magnesium"] == null ? null : List<String>.from(json["Magnesium"].map((x) => x)),
    // potassium: json["Potassium"] == null ? null : List<String>.from(json["Potassium"].map((x) => x)),
    // selenium: json["Selenium"] == null ? null : List<String>.from(json["Selenium"].map((x) => x)),
  );
