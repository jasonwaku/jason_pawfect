...
class PetAddNewScreen extends StatefulWidget {
  static String tag = 'pet-add-new-page';

  @override
  _PetAddNewScreenState createState() => _PetAddNewScreenState();
}

class _PetAddNewScreenState extends State<PetAddNewScreen> {
//
  List<String> _breeds = [
    'Airedale Terrier',
    'American Bulldog',
